...
function AlertTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "[&_a]:hover:text-foreground font-medium group-has-[>svg]/alert:col-start-2 [&_a]:underline [&_a]:underline-offset-3 *:[svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
...
function AlertDescription({
  ...
  return (
    <div
      ...
      className={cn(
        "text-muted-foreground [&_a]:hover:text-foreground text-sm md:text-pretty [&_a]:underline [&_a]:underline-offset-3 [&_p:not(:last-child)]:mb-4",
        className,
      )}
      {...props}
    />
