...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "md:items-left flex flex-col items-center gap-0.5 p-4 group-data-[vaul-drawer-direction=bottom]/drawer-content:text-center group-data-[vaul-drawer-direction=top]/drawer-content:text-center md:gap-1.5 md:text-left",
        className,
      )}
      {...props}
    />
...
function DrawerFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "mt-auto flex flex-col gap-2 p-4 in-[form]:mt-0 in-[form]:p-0 in-[form]:pb-4",
        className,
      )}
      {...props}
    />
...
function DrawerTitle({
  ...
  return (
    <DrawerPrimitive.Title
      ...
      className={cn(
        "text-foreground text-base font-medium **:[svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
